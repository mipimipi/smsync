...
* `--add-only` / `-a`
  Files and directories will only be added on slave side, existing files and directories will not be deleted or overwritten. This option can be used if a synchronization has been stopped before its was completely done.
